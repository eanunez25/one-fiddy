...
class ResultsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create result" do
    assert_difference('Result.count') do
      post results_url, params: { result: { accuracy: @result.accuracy, user: @result.user, wmp: @result.wmp } }
    end
  ...
  test "should update result" do
    patch result_url(@result), params: { result: { accuracy: @result.accuracy, user: @result.user, wmp: @result.wmp } }
